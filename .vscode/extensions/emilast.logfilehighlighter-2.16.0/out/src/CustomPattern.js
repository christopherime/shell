...
class CustomPattern {
    constructor(pattern, foreground, background, fontWeight, fontStyle, border, borderRadius, borderSpacing, letterSpacing, overviewRulerColor, overviewRulerLane, textDecoration) {
