...
* Added new text decoration options for custom patterns:
  ...
  * textDecoration
  ...
  ```
  ![Text decorations result](https://github.com/emilast/vscode-logfile-highlighter/raw/HEAD/content/text_decorations.png)
...
* Temporarily rolled back package updates to be the same as 2.11.0 since some kind of memory error seems to have appeared with custom patterns (issue [#286](https://github.com/emilast/vscode-logfile-highlighter/issues/286)).
