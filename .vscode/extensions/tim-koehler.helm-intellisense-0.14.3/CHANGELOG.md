...
## [0.14.2] - 2022-05-18
### Fixed
- Linter will ignore comments: [#47](https://github.com/tim-koehler/Helm-Intellisense/issues/47)
- Linter will ignore files that are not under the /template directory [#54](https://github.com/tim-koehler/Helm-Intellisense/issues/54)
...
## [0.13.2] - 2021-11-26
### Fixed
- Issue [#46](https://github.com/tim-koehler/Helm-Intellisense/issues/46)

## [0.13.1] - 2021-10-17
### Fixed
- Issue [#42](https://github.com/tim-koehler/Helm-Intellisense/issues/42)
...
## [0.10.0] - 2021-06-06
### Added
- Value file overriding (hierarchy) (Issue [#35](https://github.com/tim-koehler/Helm-Intellisense/issues/35))
## [0.9.4] - 2021-04-26
### Changed
- 'Rate me' popup. See issue [#33](https://github.com/tim-koehler/Helm-Intellisense/issues/33).
## [0.9.3] - 2021-04-02
### Fixed
- Security issue
### Added
...
## [0.9.2] - 2021-02-25
### Fixed
- Issue [#29](https://github.com/tim-koehler/Helm-Intellisense/issues/29)
## [0.9.1] - 2021-02-03
### Fixed
- Issue [#27](https://github.com/tim-koehler/Helm-Intellisense/issues/27)
...
## [0.7.8] - 2020-11-09
### Fixed
- Issue [#21](https://github.com/tim-koehler/Helm-Intellisense/issues/21)
...
## [0.7.4] - 2020-08-16
### Changed
- Issue [#15](https://github.com/tim-koehler/Helm-Intellisense/issues/15) -> Preventing focus switch to output when linter ran. 
### Fixed
- Bug which causes linter to crash in some cases.

## [0.7.3] - 2020-08-16
### Changed
- Issue [#14](https://github.com/tim-koehler/Helm-Intellisense/issues/14) -> Linter will ignore missing value if `default` is set.
...
- Issue [#3](https://github.com/tim-koehler/Helm-Intellisense/issues/3) (Limit suggestions to go template actions).
